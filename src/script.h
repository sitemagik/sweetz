...
#ifndef H_sweetcoin_SCRIPT
#define H_sweetcoin_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CsweetcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, sweetcoin always counted CHECKMULTISIGs
