...
void StartNode(void* parg)
{
    ...
    Generatesweetcoins(GetBoolArg("-gen", false), pwalletMain);
...
bool StopNode()
{
    ...
    if (vnThreadsRunning[THREAD_MINER] > 0) printf("ThreadsweetcoinMiner still running\n");
