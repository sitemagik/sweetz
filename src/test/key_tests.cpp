...
static const CsweetcoinAddress addr1 ("PU6Cr256nZyNcEPrkeUNtLqax81xBGkGzU");
static const CsweetcoinAddress addr2 ("PXiEuHjXJ5GD4GM3on98djkXWJymzqn95y");
static const CsweetcoinAddress addr1C("PX87vXknPK6wPEHD7gft16CXTVMiBswcQ5");
static const CsweetcoinAddress addr2C("PR5HiPNoQhbcp6KGGLE7E9SvGRHhWpjaw6");
...
void dumpKeyInfo(uint256 privkey)
{
    ...
    for (int nCompressed=0; nCompressed<2; nCompressed++)
    {
        ...
        printf("    * address (base58): %s\n", CsweetcoinAddress(vchPubKey).ToString().c_str());
    }
}
#endif
...
{
    CsweetcoinSecret bsecret1, bsecret2, bsecret1C, bsecret2C, baddress1;
