// Copyright (c) 2012 The sweetcoin developers
// Copyright (c) 2012-2015 The Peercoin developers
// Copyright (c) 2014-2015 The Paycoin developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
#ifndef sweetcoin_VERSION_H
#define sweetcoin_VERSION_H
...
// sweetcoin version - reference for code tracking
#define sweetcoin_VERSION_MAJOR       0
#define sweetcoin_VERSION_MINOR       6
#define sweetcoin_VERSION_REVISION    3
#define sweetcoin_VERSION_BUILD       0

static const int sweetcoin_VERSION =
                           1000000 * sweetcoin_VERSION_MAJOR
                         +   10000 * sweetcoin_VERSION_MINOR
                         +     100 * sweetcoin_VERSION_REVISION
                         +       1 * sweetcoin_VERSION_BUILD;

static const int CLIENT_VERSION = sweetcoin_VERSION;
