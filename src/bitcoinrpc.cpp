...
Value setgenerate(const Array& params, bool fHelp)
{
    ...
    Generatesweetcoins(fGenerate, pwalletMain);
    return Value::null;
}
...
Value getblocktemplate(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "See https://en.sweetcoin.it/wiki/BIP_0022 for full specification.");
...
Value gettxout(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            " \"addresses\" : [ (array of string) array of sweetcoin addresses\n"
            " \"sweetcoinaddress\" (string) sweetcoin address\n"
            " ,...\n"
            " ]\n"
            " },\n"
...
//
// JSON-RPC protocol.  sweetcoin speaks version 1.0 for maximum compatibility,
