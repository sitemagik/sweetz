...
#ifndef sweetcoin_UI_INTERFACE_H
#define sweetcoin_UI_INTERFACE_H
...
/* These UI communication functions are implemented in sweetcoin.cpp (for ui) and noui.cpp (no ui) */
