 ...
 * The sweetcoin Developers 2011-2012
...
sweetcoinGUI::sweetcoinGUI(QWidget *parent):
    QMainWindow(parent),
    clientModel(0),
    walletModel(0),
...
void sweetcoinGUI::createActions()
{
...
void sweetcoinGUI::createMenuBar()
{
#ifdef Q_OS_MAC
...
void sweetcoinGUI::createToolBars()
{
...
void sweetcoinGUI::setClientModel(ClientModel *clientModel)
{
...
void sweetcoinGUI::setWalletModel(WalletModel *walletModel)
{
...
void sweetcoinGUI::createTrayIcon()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
...
#ifndef Q_OS_MAC
void sweetcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void sweetcoinGUI::optionsClicked()
{
...
void sweetcoinGUI::aboutClicked()
{
    AboutDialog dlg;
...
void sweetcoinGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
...
void sweetcoinGUI::setNumBlocks(int count)
{
...
void sweetcoinGUI::error(const QString &title, const QString &message, bool modal)
{
    // Report errors from network/worker thread
    if(modal)
    {
...
void sweetcoinGUI::changeEvent(QEvent *e)
{
...
void sweetcoinGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void sweetcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage =
        tr("This transaction is over the size limit. You can still send it for a fee of %1. Do you want to pay the fee?").arg(
                sweetcoinUnits::formatWithUnit(sweetcoinUnits::BTC, nFeeRequired));
...
void sweetcoinGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
        ...
        notificator->notify(Notificator::Information,
                            (amount)<0 ? tr("Sent transaction") :
                              ...
                              tr("Date: %1\n"
                                 ...
                                 "Address: %4\n")
                              .arg(date)
                              .arg(sweetcoinUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                              .arg(type)
                              .arg(address), icon);
    }
}

void sweetcoinGUI::gotoOverviewPage()
{
...
void sweetcoinGUI::gotoHistoryPage()
{
...
void sweetcoinGUI::gotoMintingPage()
{
...
void sweetcoinGUI::gotoAddressBookPage()
{
...
void sweetcoinGUI::gotoReceiveCoinsPage()
{
...
void sweetcoinGUI::gotoSendCoinsPage()
{
...
void sweetcoinGUI::gotoMessagePage()
{
#ifdef FIRST_CLASS_MESSAGING
...
void sweetcoinGUI::gotoMultisigPage()
{
    multisigPage->show();
    multisigPage->setFocus();
}

void sweetcoinGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void sweetcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        gotoSendCoinsPage();
...
void sweetcoinGUI::handleURI(QString strURI)
{
    gotoSendCoinsPage();
...
void sweetcoinGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void sweetcoinGUI::encryptWallet(bool status)
{
    if(!walletModel)
        return;
...
void sweetcoinGUI::unlockForMinting(bool status)
{
    if(!walletModel)
        return;
...
void sweetcoinGUI::backupWallet()
{
...
void sweetcoinGUI::changePassphrase()
{
...
void sweetcoinGUI::unlockWallet()
{
    if(!walletModel)
        return;
...
void sweetcoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void sweetcoinGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void sweetcoinGUI::editConfig()
{
    QMessageBox mb;
