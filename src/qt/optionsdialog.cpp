...
private:
    sweetcoinAmountField *fee_edit;
    QCheckBox *sweetcoin_at_startup;
       ...
       OptionsPage(parent)
{
    ...
    fee_edit = new sweetcoinAmountField();
    ...
    sweetcoin_at_startup = new QCheckBox(tr("&Start Paycoin on system login"));
    sweetcoin_at_startup->setToolTip(tr("Automatically start Paycoin after logging in to the system"));
    layout->addWidget(sweetcoin_at_startup);
...
void MainOptionsPage::setMapper(MonitoredDataMapper *mapper)
{
    ...
    mapper->addMapping(sweetcoin_at_startup, OptionsModel::StartAtStartup);
