...
contains(sweetcoin_NEED_QT_PLUGINS, 1) {
    DEFINES += sweetcoin_NEED_QT_PLUGINS
...
HEADERS += src/qt/sweetcoingui.h \
    ...
    src/qt/sweetcoinaddressvalidator.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
    src/checkpoints.h \
...
SOURCES += src/qt/sweetcoin.cpp src/qt/sweetcoingui.cpp \
    ...
    src/qt/sweetcoinaddressvalidator.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    src/netbase.cpp \
    ...
    src/qt/sweetcoinstrings.cpp \
    src/qt/sweetcoinamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
    src/qt/transactionfilterproxy.cpp \
    src/qt/transactionview.cpp \
    src/qt/walletmodel.cpp \
    src/sweetcoinrpc.cpp \
...
contains(sweetcoin_QT_TEST, 1) {
SOURCES += src/qt/test/test_main.cpp \
    src/qt/test/uritests.cpp
HEADERS += src/qt/test/uritests.h
DEPENDPATH += src/qt/test
QT += testlib
TARGET = sweetcoin-qt_test
DEFINES += sweetcoin_QT_TEST
}

CODECFORTR = UTF-8

# for lrelease/lupdate
# also add new translations to src/qt/sweetcoin.qrc under translations/
...
windows:RC_FILE = src/qt/res/sweetcoin-qt.rc
