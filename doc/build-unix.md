...
cd src/
make -f makefile.unix            # Headless sweetcoin

See readme-qt.md for instructions on building sweetcoin QT,
the graphical sweetcoin.
...
Security
--------
To help make your sweetcoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, sweetcoin should be built with a non-executable stack
